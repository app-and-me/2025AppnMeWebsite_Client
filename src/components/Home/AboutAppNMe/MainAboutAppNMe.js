    ...
    return (
        <div className={styles.Container}>
            ...
            <div className={styles["title-container"]}>
                <div className={styles.dotTitle}> <DotTitle dotTitle={"About App & Me"} /></div>
                ...
                <div className={styles.btn}><Button width={"89px"} height={"46px"} borderRadius={"10px"} text={"지원하기"} onClick={handleClick} /></div>
            </div>
        </div>
    )
}